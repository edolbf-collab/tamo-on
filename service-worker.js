const SW_BUILD = 159;
const CACHE = "tamo-on-beta-1.0-build-159-r1";
...
const ASSETS = [
  "/",
  "/legal/acceptance.js?v=beta159r1",
  "/legal/legal.css?v=beta159r1",
  "/legal/",
  "/legal/public.js?v=beta159r1",
  "/legal/termos-de-uso-v1.2.html",
  "/legal/privacidade-v1.2.html",
  "/legal/codigo-de-conduta-v1.2.html",
  "/index.html",
  "/styles.css?v=beta159r1",
  "/app.js?v=beta159r1",
  "/pwa-bootstrap.js?v=beta159r1",
  "/supabase-config.js?v=0.3.3",
  "/group-avatars-data.js?v=beta159r1",
  "/assets/group-avatars-build-142/badge-01.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-02.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-03.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-04.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-05.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-06.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-07.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-08.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-09.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-10.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-11.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-12.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-13.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-14.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-15.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-16.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-17.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-18.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-19.png?v=beta159r1",
  "/assets/group-avatars-build-142/badge-20.png?v=beta159r1",
  "/manifest.json",
  "/offline.html",
  "/version.json",
