(() => {
  ...
  const APP_RELEASE = Object.freeze({ channel: "beta", version: "Beta 1.0", build: 141, database: 140, edge: 110 });
  const APP_ASSET_TOKEN = "beta141r2";
  ...
  const groupAvatarUrl = key => {
    ...
    return window.TAMOON_GROUP_AVATARS?.[normalized] || assetUrl(`assets/group-avatars/${normalized}.png?v=beta141r2`);
  };
  ...
  const App = {
    ...
    bindGlobal() {
      ...
      document.addEventListener("error", event => {
        ...
        image.src = window.TAMOON_GROUP_AVATARS?.["badge-01"] || assetUrl("assets/group-avatars/badge-01.png?v=beta141r2");
      }, true);
    },
